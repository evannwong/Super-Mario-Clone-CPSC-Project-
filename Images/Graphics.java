...
public class Graphics{
  ...
  /** Node created to pull in the image to use for the background. The dimensions and coordinates for the image are set inside of this method */
  public Node createWin(int x, int y, int w, int h){
    ImageView win = new ImageView("https://raw.githubusercontent.com/RMcCurdy/TeamProjectGroup14/master/Images/youWinTest.png?token=ApkDjG3QpMdkdKtqJ4uwSCDIybeWTQbJks5cjg1RwA%3D%3D");
    win.setX(x);
    win.setY(y);
    win.setFitWidth(w);
    win.setFitHeight(h);
